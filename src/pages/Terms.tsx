          ...
          <div className="prose prose-slate max-w-none space-y-6 text-muted-foreground">
            ...
            <section>
              ...
              <p>
                ...
                администрацией платформы «ДедМороз.kg» (далее — «Платформа») и пользователями Платформы.
              </p>
              <p>
                Платформа является информационным посредником между заказчиками услуг (клиентами) и 
                исполнителями новогодних поздравлений на территории Кыргызской Республики.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                ...
                Все споры подлежат рассмотрению в судах г. Бишкек.
              </p>
            </section>
            ...
            <section>
              ...
              <ul className="list-none space-y-1">
                <li>Email: support@dedmoroz.kg</li>
